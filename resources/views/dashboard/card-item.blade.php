@php
    ...
    // distinct donor regencies count
    ...
    <div class="card">
      <div class="card-body p-3">
        <div class="row">
          <div class="col-8">
            <div class="numbers">
              <p class="text-sm mb-0 text-uppercase font-weight-bold">JUMLAH DONATUR</p>
    ...
    <div class="card">
      <div class="card-body p-3">
        <div class="row">
          <div class="col-8">
            <div class="numbers">
              <p class="text-sm mb-0 text-uppercase font-weight-bold">JUMLAH KABUPATEN</p>
              <h5 class="font-weight-bolder">
               {{ $regencies }}
              </h5>
            </div>
    ...
    <div class="card">
      <div class="card-body p-3">
        <div class="row">
          <div class="col-8">
            <div class="numbers">
              <p class="text-sm mb-0 text-uppercase font-weight-bold">JUMLAH FUNDRAISER</p>
              <h5 class="font-weight-bolder">
                {{ number_format($fundrisers) }}
              </h5>
            </div>
          </div>
          <div class="col-4 text-end">
