...
<x-layouts.app>
    ...
    <div class="col-12 col-md-8 col-lg-6 col-xl-5">
      <div class="card mb-4 shadow-sm border-0">
        <div class="card-header pb-0 d-flex justify-content-between align-items-center">
          <h6 class="mb-0 font-weight-bold">Tanda Terima Donasi</h6>
          <div class="d-flex gap-2">
            ...
            <button type="button" class="btn btn-xs btn-primary text-white mb-0 shadow-none" onclick="printReceiptPreview()">
  ...
  <!-- Hidden 755x1600 Full-Res Capture Node for Pixel-Perfect JPG & PDF Export -->
